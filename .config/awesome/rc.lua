...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
            function ()
                audioctl.set_volume("+5\\%")
                --local default_sink = get_command_output("/usr/bin/pactl get-default-sink");
                --awful.util.spawn("/usr/bin/pactl -- set-sink-volume ".. default_sink .." +5\\%", false)
